...
#SBATCH --output=/maps/projects/course_1/scratch/<group_#>/logs/antiSMASH_%j.out
#SBATCH --error=/maps/projects/course_1/scratch/<group_#>/logs/antiSMASH_%j.err
...
INPUT1="/maps/projects/course_1/scratch/group3/group-project-group-3/week19-mags/09_annotation_bakta_ref/${sample1}/${sample1}.gbff"
OUTDIR1="/maps/projects/course_1/scratch/group3/group-project-group-3/week19-mags/11_annotation_BGC_ref/${sample1}"
mkdir -p "${OUTDIR1}"
...
INPUT2="/maps/projects/course_1/scratch/group3/group-project-group-3/week19-mags/09_annotation_bakta_ref/${sample2}/${sample2}.gbff"
OUTDIR2="/maps/projects/course_1/scratch/group3/group-project-group-3/week19-mags/11_annotation_BGC_ref/${sample2}"
mkdir -p "${OUTDIR2}"
...
INPUT3="/maps/projects/course_1/scratch/group3/group-project-group-3/week19-mags/09_annotation_bakta_ref/${sample3}/${sample3}.gbff"
OUTDIR3="/maps/projects/course_1/scratch/group3/group-project-group-3/week19-mags/11_annotation_BGC_ref/${sample3}"
mkdir -p "${OUTDIR3}"
